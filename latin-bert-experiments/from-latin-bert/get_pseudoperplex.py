...
from transformers import BertModel, BertPreTrainedModel, AutoModelForMaskedLM, AutoTokenizer #second two are from other code
...
if __name__ == "__main__":
	...
	bert_sents=bert.get_batches(sents, 32, LatinTokenizer(text_encoder.SubwordTextEncoder(tokenizerPath)))
    ...
    # tokenizer = LatinTokenizer(text_encoder.SubwordTextEncoder(tokenizerPath))
	
    # def score(model, tokenizer, sentence):
    #     tensor_input = convert_to_toks([sentence])
    #     print(tensor_input)
